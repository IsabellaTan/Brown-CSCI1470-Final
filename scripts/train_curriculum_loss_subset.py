...
def main(args):
    ...
    temp_loader = DataLoader(train_set, batch_size=cfg.batch_size, shuffle=False,num_workers=0)
   ...
   # Step3: Divide epoch
    for epoch in range(1, cfg.epochs + 1):
        ...
        train_loader = DataLoader(subset, batch_size=cfg.batch_size, shuffle=True, num_workers=0)
